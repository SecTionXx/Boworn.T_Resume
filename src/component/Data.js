...
export const frontEndStackData = [
  "HTML",
  "CSS",
  "TAILWIND",
  "Javascripts",
...
export const computerSkillData = [
...
export const educationData = [
  {
    ...
    univercity: "TechUp Thailand",
    year: 2023,
  },
  {
    degree: "Bachelor of Engineering Program in Industial Engineer",
    univercity: "Rajamangala university of technology krungthep",
    year: 2017,
  },
];

export const careerTratis = [
  {
    title: "Problem-solving",
    detail:
      "Demonstrated ability to approach problems from multiple angles, finding efficient and innovative solutions.",
  },
  {
    title: "Attention to detail",
    detail:
      " Proven track record of producing high-quality work with minimal errors.",
  },
  {
    title: "Creativity",
    detail:
      "Known for creative thinking and innovative approaches to complex problems.",
  },
  {
    title: "Technical proficiency",
    detail:
      "Skilled in CAD software, project management, and various programming languages and databases.",
  },
  {
    title: "Continuous learning",
    detail:
      "Committed to staying up-to-date with the latest industry trends, tools, and best practices.",
  },
  {
  ...
  },
  {
    title: "Adaptability",
    detail:
      "Quickly adapts to new tools, technologies, and changes in project requirements.",
  },
];
